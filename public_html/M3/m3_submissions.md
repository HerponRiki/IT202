...
<tr><td> <em>Generated: </em> 2/21/2022 2:09:10 AM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-008-S22/javascript-csschallenge/grade/ay43" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://i.imgur.com/S2p05Jq.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Primary stuff<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Screenshot showing after the login link is clicked (be sure to include the url)</td></tr>
<tr><td><table><tr><td><img width="768px" src="https://i.imgur.com/JhsIvRM.png"/></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://i.imgur.com/j8XhQIX.png"/></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://i.imgur.com/0YbTwlh.png"/></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://i.imgur.com/XMOeb0Z.png"/></td></tr>
...
<tr><td> <em>Response:</em> <p>I used float: left to make it horizontal<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain how you remove the navigation list item markers</td></tr>
<tr><td> <em>Response:</em> <p>to make the bullets disappear, I used list-style: none<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Briefly explain how you gave the navigation a background</td></tr>
<tr><td> <em>Response:</em> <p>I used background-color in nav ul <br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>I used li a:hover and chose a background<br></p><br></td></tr>
<tr><td> <em>Sub-Task 5: </em> Briefly explain how you changed the challenge list bullet points to checkmarks (✓)</td></tr>
<tr><td> <em>Response:</em> <p>I used body &gt; ul li::before, meaning it was looking for elements that<br>had the bullets on the left as a parent. Then used content to<br>copy and paste the checkmark<br></p><br></td></tr>
<tr><td> <em>Sub-Task 6: </em> Briefly explain how you made the first character of the h1 tags and anchor tags uppercased</td></tr>
<tr><td> <em>Response:</em> <p>In the same place, I changed the background color of the navigation bar<br>I put text-transform: capitalize that only capitalized h1<br></p><br></td></tr>
<tr><td> <em>Sub-Task 7: </em> Briefly explain/describe your custom styling of your choice</td></tr>
<tr><td> <em>Response:</em> <p>I added a box like stucture to the navigation bar and made the<br>letters bold <br></p><br></td></tr>
<tr><td> <em>Sub-Task 8: </em> Briefly explain how the styling for the challenge list doesn't impact the navigation list</td></tr>
<tr><td> <em>Response:</em> <p>The bar like structure makes the navigation bar pop and the bold allow<br>the user to see the letters better.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 9: </em> Briefly explain how you updated the content of the h1 tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>Inside updateCurrentPage I put the name of the link I wanted to change<br>the h1 tag<br></p><br></td></tr>
<tr><td> <em>Sub-Task 10: </em> Briefly explain how you updated the content of the title tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>i used updateCurrentPage()<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I could not figure out how to get the checkmarks to not appear<br>on the top of the navigation bar for the longest time. Thankfully I<br>just looked at the list and was able to figure it out when<br>I just tossed words into the compiler  <br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Add a link to your pull request (hw branch to dev only)</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/HerponRiki/IT202/pull/9">https://github.com/HerponRiki/IT202/pull/9</a> </td></tr>
<tr><td> <em>Sub-Task 3: </em> Add a link to your solution html file from prod (again you can assume the url at this point)</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://ay43-prod.herokuapp.com/M3/M3_Challenge.html">https://ay43-prod.herokuapp.com/M3/M3_Challenge.html</a> </td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-008-S22/javascript-csschallenge/grade/ay43" target="_blank">Grading</a></td></tr></table>