...
<tr><td> <em>Generated: </em> 2/14/2022 7:52:27 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-008-S22/m2-php-hw/grade/ay43" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://i.imgur.com/UseXLoO.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Problem 1 answers<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I made a for each loop to go through the list. Then I<br>had it go through an if statement to get the numbers that are<br>odd. From there I had it echo out the numbers into another list<br>using echo join(&quot;, &quot;, $oddNum);<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://i.imgur.com/Sje2f6b.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Problem 2 answers<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I used a for each loop to go through the list and added<br>all the doubles together, I used the round() function to round all the<br>numbers up. Then I had it echo out the rounded numbers.  <br><br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://i.imgur.com/LciQjPT.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Problem 3 answers<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I used another for each loop but this time I used the abs()<br>function to make all the numbers positive. <br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://ay43-prod.herokuapp.com/M2/problem1.php">https://ay43-prod.herokuapp.com/M2/problem1.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://ay43-prod.herokuapp.com/M2/problem2.php">https://ay43-prod.herokuapp.com/M2/problem2.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://ay43-prod.herokuapp.com/M2/problem3.php">https://ay43-prod.herokuapp.com/M2/problem3.php</a> </td></tr>
<tr><td> <em>Sub-Task 4: </em> Pull Request URL for M2-PHP-HW to dev</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/HerponRiki/IT202/pull/4">https://github.com/HerponRiki/IT202/pull/4</a> </td></tr>
<tr><td> <em>Sub-Task 5: </em> Talk about what you learned, any issues you had, how you resolve them</td></tr>
<tr><td> <em>Response:</em> <p>I learned how to use the foreach loops and how to echo out<br>lists with a comma. I also have a better understanding of how PHP<br>works and I am growing more comfortable with how to use the dev/prod<br>and git.  <br></p><br></td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-008-S22/m2-php-hw/grade/ay43" target="_blank">Grading</a></td></tr></table>